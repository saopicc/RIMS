...
def convertSrclist(srclist, ms, fieldradius):
...
if __name__ == "__main__":
    ...
    D = DynSpecMS(ListMSName=args.ms, ColName=args.data, ModelName=args.model, Sols=args.sols, UVRange=args.uv)
    for src in args.srclist.keys():
        D.source = src
        D.StackAll(ra=args.srclist[src]['RA'], dec=args.srclist[src]['Dec'])
        D.WriteFits()
        #D.PlotSpec 
# =========================================================================
# =========================================================================
